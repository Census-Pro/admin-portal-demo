...
export interface RelationshipApplicationApproval {
  id: string;
  createdAt: string;
  updatedAt: string;
...
function ActionsCell({
  ...
  application: RelationshipApplicationApproval;
}) {
  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        ...
        onClick={() =>
          router.push(
            `/dashboard/relation-certificate/${application.id}?from=approval`
          )
        }
      >
...
export const approvalColumns: ColumnDef<RelationshipApplicationApproval>[] = [
  {
