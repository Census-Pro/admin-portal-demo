...
function ActionsCell({
  ...
  application: NationalityApplicationPayment;
}) {
  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        ...
        onClick={() =>
          router.push(
            `/dashboard/nationality-certificate/${application.id}?from=payment`
          )
        }
      >
...
export const paymentColumns: ColumnDef<NationalityApplicationPayment>[] = [
  {
