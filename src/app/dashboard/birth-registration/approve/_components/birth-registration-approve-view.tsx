...
import { markBirthApproved } from '@/lib/cid-assessed-store';
...
export function BirthRegistrationApproveView({
  ...
  const handleApprove = async () => {
    try {
      setIsApproving(true);
      markBirthApproved(applicationId);
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Are you sure you want to approve this birth
                  ...
                  >
                    <DialogContent className="sm:max-w-md">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Are you sure you want to reject this birth
