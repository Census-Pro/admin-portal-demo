...
export const workspacesInfoContent: InfobarContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      description:
        'To create a new workspace, you can set up new projects and configure initial settings. Once created, you can switch to the new workspace and start managing it.',
      links: []
    },
    {
      title: 'Switching Workspaces',
      description:
        'You can switch between workspaces by selecting a workspace from the available options. The selected workspace becomes your active context, and all workspace-specific features will use this workspace.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'This application follows recommended patterns for multi-tenant authentication. Server-side permission checks ensure that users can only access resources for their active workspace.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Team Management page allows you to manage your workspace team, including members, roles, security settings, and more. This page provides comprehensive organization management features.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'Configure default roles and permissions in your application settings. Roles define what actions team members can perform within the workspace. Common roles include admin, member, and custom roles you define.',
      links: []
    },
    {
  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Billing page allows you to manage your organization's subscription and usage limits. Plans and subscriptions provide organization-level subscription management with integrated payment processing.",
      links: []
    },
    {
      title: 'Available Plans',
      description:
        'View and subscribe to available plans through the pricing table. Plans are created and managed in your application settings. Common plans include free, pro, and team tiers.',
      links: []
    },
    {
      title: 'Plan Features',
      description:
        'Each plan can include specific features that unlock functionality in the application. Features are added to plans in your application settings and can be checked in code using feature flags.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'Payment processing is handled through integrated payment providers like Stripe. Transaction fees are paid directly to your payment provider. Plans and pricing are managed through your application settings.',
      links: []
    },
    {
      title: 'Setup Requirements',
      description:
        'To enable billing, configure your payment provider settings in your application. Choose between development and production environments for testing and live transactions respectively.',
      links: []
    },
    {
      title: 'Beta Status',
      description:
        'Billing features are continuously being improved. We recommend keeping your dependencies up to date and following best practices for subscription management.',
      links: []
    }
  ]
};
