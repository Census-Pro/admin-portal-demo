...
const dummyHohChanges = [
  {
    ...
    lastName: 'Wangchuk',
    reasonForChange:
      'Current HOH is elderly and unable to manage household affairs',
    houseNo: 'H-045',
    dzongkhagName: 'Thimphu',
    gewogName: 'Kawang',
    chiwogName: 'Dechencholing',
    villageName: 'Hejo',
    status: 'SUBMITTED',
  ...
  },
  {
    ...
    middleName: '',
    lastName: 'Penjor',
    reasonForChange: 'Current HOH migrating abroad',
    houseNo: 'H-112',
    dzongkhagName: 'Paro',
    gewogName: 'Shaba',
    chiwogName: 'Doteng',
  ...
  },
  {
    ...
    middleName: '',
    lastName: 'Dema',
    reasonForChange: 'Current HOH incapacitated due to illness',
    houseNo: 'H-078',
  ...
  },
  {
    ...
    middleName: '',
    lastName: 'Thinley',
    reasonForChange: 'Death of current HOH',
    houseNo: 'H-033',
    dzongkhagName: 'Wangdue Phodrang',
    gewogName: 'Nishog',
    chiwogName: 'Rinchengang',
    villageName: 'Rinchengang',
    status: 'APPROVED',
  ...
  },
  {
    ...
    middleName: '',
    lastName: 'Dorji',
    reasonForChange: 'Current HOH transferred to another location',
    houseNo: 'H-067',
    dzongkhagName: 'Bumthang',
    gewogName: 'Chumey',
    chiwogName: 'Ngang Lhakhang',
    villageName: 'Ngang',
    status: 'SUBMITTED',
  ...
  {
    id: '6',
    applicationNo: 'HOH-2024-006',
    applicantCidNo: '10304003011',
    applicantIs: 'Family Member',
    householdNo: 'HH-006',
    hohCidNo: '10304003011',
    newHohCidNo: '10304003012',
    firstName: 'Pema',
    middleName: '',
    lastName: 'Seldon',
    reasonForChange:
      'Current HOH remarried and relocated to different household',
    houseNo: 'H-091',
